...
```
export SUBSCRIPTION_ID=7fdadc4c-a7d4-4b1e-a2a3-e015ecb7ae1f  #s id
export RESOURCE_GROUP=keyvault-demo
export UAMI=azurekeyvaultsecretsprovider-keyvault-demo-cluster
export KEYVAULT_NAME=aks-kv-shiva
...
spec:
  ...
  parameters:
    ...
    objects:  |
      array:
        - |
          objectName: secretforaks            # Set to the name of your secret
          objectType: secret              # object types: secret, key, or cert
          objectVersion: ""               # [OPTIONAL] object versions, default to latest if empty
        - |
          objectName: keyforaks               # Set to the name of your key
          objectType: key
          objectVersion: ""
